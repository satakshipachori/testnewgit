		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#project1tesgit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"project1tesgit-display": {
								"semanticObject": "project1tesgit",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project1tesgit",
									"url": sap.ui.require.toUrl("project1tesgit")
								}
							}
						}
					}
